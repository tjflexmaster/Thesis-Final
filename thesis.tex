...
\lstdefinelanguage{XML}
{
  ...
  morekeywords={xmlns,version,type,name,source,target,showMetrics,dataType,load,durationMin,durationMax,priority,count}% list your attributes here
}
...
\committeemembera{Eric~M.~Mercer}
\committeememberb{Kevin~Seppi}
...
\input{chapter_example.tex}
\input{chapter_workload.tex}
%\input{chapter_paper2.tex}
%\input{chapter_xml_parser.tex}
%\input{chapter_metrics.tex}
\input{chapter_UASinNAS.tex}
\input{chapter_relatedwork.tex}
