...
\input{chapter_paper1.tex}
\input{chapter_paper2.tex}
\input{chapter_refactor.tex}
\input{chapter_UASinNAS.tex}
\input{chapter_conclusion_futurework.tex}
\appendix
\input{appendix_proposal.tex}
\input{appendix_java_classes.tex}
\input{appendix_xml_model.tex}
\input{appendix_model_logs.tex}
