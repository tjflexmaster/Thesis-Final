...
On the other hand the decision workload typically jumps all over the place.  Currently we not sure exactly how important the decision workload is to overall workload metric.  While we believe the increase in decision workload does in fact increase workload we are unsure how to weight this value in comparison with the resource and temporal workload values.  This is something we will explore in future work.
